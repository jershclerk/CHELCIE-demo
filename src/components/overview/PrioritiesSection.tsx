  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="flex flex-col">
        <p className="text-xl font-semibold tracking-[-0.45px] text-black">Priorities</p>
      ...
      <div className="flex w-full flex-col gap-4">
        {priorities.map(({ title, amount, owner, deadline, tag }) => (
          <button
            key={title}
            type="button"
            className="flex w-full items-center justify-between gap-4 rounded-[20px] bg-white p-5 text-left transition-colors hover:bg-muted/50"
          >
            <div className="flex flex-col gap-1.5">
              <p className="text-xl font-semibold tracking-[-0.45px] text-black">{title}</p>
              ...
              <Badge variant="outline" className="mt-1 w-fit rounded-lg px-2.5 py-1 text-xs font-normal text-chelcie-label-secondary">
                {tag}
              </Badge>
            </div>
